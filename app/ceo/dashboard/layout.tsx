...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { name: 'Dashboard', href: '/ceo/dashboard/admin', icon: LayoutDashboard },
    { name: 'Outbound Campaigns', href: '/ceo/dashboard/campaigns', icon: Mail },
    {name: 'Metrics', href:'/ceo/dashboard/metrics', icon: Users },
      {name: 'Outbound Queue', href:'/ceo/dashboard/prospects', icon: Users }
  ];
